...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_KINDLER_DREW, TRAINER_GYM_RANGER_F_AMARI, TRAINER_GYM_KINDLER_FRANCO, TRAINER_SKIP_GRASS_2, TRAINER_SKIP_FIRE_2, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_SKIP_WATER_2, TRAINER_SAILOR_SANTIAGO, TRAINER_PARASOL_JUNE, TRAINER_TUBER_IZZIE, TRAINER_SAILOR_LEE, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_SKIP_FIRE_3, TRAINER_GRUNT_HIDEOUT_2, TRAINER_SCIENTIST_HIDEOUT_1, TRAINER_SCIENTIST_HIDEOUT_2, TRAINER_SCIENTIST_HIDEOUT_3, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_GRUNT_HIDEOUT_3, TRAINER_SCIENTIST_HIDEOUT_6, TRAINER_GRUNT_HIDEOUT_4, TRAINER_SCIENTIST_HIDEOUT_7, TRAINER_RANGER_NIKOLAI, ROUTE109),
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_SKIP2_GRASS, TRAINER_TUBER_F_CARLY, TRAINER_FISHERMAN_TODD, TRAINER_BUG_CATCHER_MITCH, TRAINER_BUG_MANIAC_GARY, ROUTE111),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_HIKER_EDWIN_1, TRAINER_HIKER_EDWIN_2, TRAINER_HIKER_EDWIN_3, TRAINER_HIKER_EDWIN_4, TRAINER_HIKER_EDWIN_5, ROUTE110),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_BLACKBELT_BEN, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_CODY_1, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_GYM_LEADER_LILITH, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_GYM_LEADER_BRUCE, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_GYM_LEADER_BERNIE, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_GYM_LEADER_EDGAR, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, LAVARIDGE_TOWN),
