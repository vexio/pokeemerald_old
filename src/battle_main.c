...
// gTypeNames is the text that shows up after "TYPE/" in the FIGHT menu
// Below is my attempt at adding the typing icons to be displayed after the "TYPE/" text
// The code below is ported from pokemon_summary_screen.c
...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_AQUA_ADMIN, 25},
    {TRAINER_CLASS_AQUA_LEADER, 30},
    {TRAINER_CLASS_AROMA_LADY, 10},
    {TRAINER_CLASS_RUIN_MANIAC, 20},
    {TRAINER_CLASS_INTERVIEWER, 25},
    {TRAINER_CLASS_TUBER_F, 8},
    {TRAINER_CLASS_TUBER_M, 8},
    {TRAINER_CLASS_SIS_AND_BRO, 20},
    {TRAINER_CLASS_ACE_TRAINER, 12},
    {TRAINER_CLASS_HEX_MANIAC, 15},
    {TRAINER_CLASS_LADY, 25},
    {TRAINER_CLASS_BEAUTY, 50},
    {TRAINER_CLASS_RICH_BOY, 50},
    {TRAINER_CLASS_POKEMANIAC, 25},
    {TRAINER_CLASS_SWIMMER_M, 15},
    {TRAINER_CLASS_BLACK_BELT, 20},
    {TRAINER_CLASS_GUITARIST, 15},
    {TRAINER_CLASS_KINDLER, 15},
    {TRAINER_CLASS_CAMPER, 20},
    {TRAINER_CLASS_OLD_COUPLE, 30},
    {TRAINER_CLASS_BUG_MANIAC, 15},
    {TRAINER_CLASS_PSYCHIC, 25},
    {TRAINER_CLASS_GENTLEMAN, 40},
    {TRAINER_CLASS_ELITE_FOUR, 60},
    {TRAINER_CLASS_LEADER, 50},
    {TRAINER_CLASS_SCHOOL_KID, 10},
    {TRAINER_CLASS_SR_AND_JR, 20},
    {TRAINER_CLASS_POKEFAN, 20},
    {TRAINER_CLASS_EXPERT, 30},
    {TRAINER_CLASS_YOUNGSTER, 10},
    {TRAINER_CLASS_CHAMPION, 75},
    {TRAINER_CLASS_FISHERMAN, 10},
    {TRAINER_CLASS_TRIATHLETE, 15},
    {TRAINER_CLASS_DRAGON_TAMER, 25},
    {TRAINER_CLASS_BIRD_KEEPER, 15},
    {TRAINER_CLASS_NINJA_BOY, 10},
    {TRAINER_CLASS_BATTLE_GIRL, 10},
    {TRAINER_CLASS_PARASOL_LADY, 30},
    {TRAINER_CLASS_SWIMMER_F, 15},
    {TRAINER_CLASS_PICNICKER, 20},
    {TRAINER_CLASS_TWINS, 10},
    {TRAINER_CLASS_SAILOR, 15},
    {TRAINER_CLASS_COLLECTOR, 25},
    {TRAINER_CLASS_PKMN_TRAINER_3, 40},
    {TRAINER_CLASS_PKMN_BREEDER, 20},
    {TRAINER_CLASS_PKMN_RANGER, 25},
    ...
    {TRAINER_CLASS_YOUNG_COUPLE, 20},
    {TRAINER_CLASS_WINSTRATE, 10},
    {TRAINER_CLASS_ELECTRICIAN, 20},
    {TRAINER_CLASS_MINER, 15},
    {TRAINER_CLASS_ENGINEER, 20},
    {TRAINER_CLASS_SCIENTIST, 30},
    {0xFF, 5},
};
