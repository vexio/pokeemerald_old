...
const u8 gText_DefaultNameStu[] = _("Brandon");
const u8 gText_DefaultNameMilton[] = _("Brandon");
const u8 gText_DefaultNameTom[] = _("Brandon");
const u8 gText_DefaultNameKenny[] = _("Brandon");
const u8 gText_DefaultNameReid[] = _("Brandon");
const u8 gText_DefaultNameJude[] = _("Brandon");
const u8 gText_DefaultNameJaxson[] = _("Brandon");
const u8 gText_DefaultNameEaston[] = _("Brandon");
const u8 gText_DefaultNameWalker[] = _("Brandon");
const u8 gText_DefaultNameTeru[] = _("Brandon");
const u8 gText_DefaultNameJohnny[] = _("Brandon");
const u8 gText_DefaultNameBrett[] = _("Brandon");
const u8 gText_DefaultNameSeth[] = _("Brandon");
const u8 gText_DefaultNameTerry[] = _("Brandon");
const u8 gText_DefaultNameCasey[] = _("Brandon");
const u8 gText_DefaultNameDarren[] = _("Brandon");
const u8 gText_DefaultNameLandon[] = _("Brandon");
const u8 gText_DefaultNameCollin[] = _("Brandon");
const u8 gText_DefaultNameStanley[] = _("Brandon");
const u8 gText_DefaultNameQuincy[] = _("Brandon");
