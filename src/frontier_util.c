...
static const u8 sFrontierBrainObjEventGfx[NUM_FRONTIER_FACILITIES][2] =
{
    ...
    [FRONTIER_FACILITY_ARENA]   = {OBJ_EVENT_GFX_ADMIN_CERES,   TRUE},
    [FRONTIER_FACILITY_FACTORY] = {OBJ_EVENT_GFX_ADMIN_NOLAND,  FALSE},
    [FRONTIER_FACILITY_PIKE]    = {OBJ_EVENT_GFX_ADMIN_HAUMEA,    TRUE},
