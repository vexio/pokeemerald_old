...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MAUVILLE_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SOOTOPOLIS_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_EVER_GRANDE_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_133] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_134] = MAPPOPUP_THEME_WOOD,
