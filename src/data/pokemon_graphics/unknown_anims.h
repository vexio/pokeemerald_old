...
static const union AnimCmd *const *const sUnknownAnimsTable[] =
{
    ...
    ANIM_CMD(HO_OH),
    ANIM_CMD(CELEBI),
    ANIM_CMD_FULL(UNOWN_B, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_C, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_D, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_E, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_F, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_G, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_H, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_I, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_J, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_K, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_L, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_M, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_N, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_O, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_P, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_Q, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_R, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_S, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_T, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_U, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_V, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_W, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_X, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_Y, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD_FULL(UNOWN_Z, sUnknownAnims_OLD_UNOWN),
    ANIM_CMD(TREECKO),
    ANIM_CMD(GROVYLE),
    ANIM_CMD(SCEPTILE),
    ANIM_CMD(TORCHIC),
