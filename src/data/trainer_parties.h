static const struct TrainerMonNoItemDefaultMoves sParty_Cody1[] = {
    {
    .iv = 0,
    .lvl = 3,
...
static const struct TrainerMonNoItemCustomMoves sParty_Fredrick[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_FIRE_FANG, MOVE_HOWL, MOVE_SWAGGER}
    },
    {
    .iv = 100,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Rose4[] = {
    ...
    .lvl = 16,
    .species = SPECIES_STARAVIA,
    .moves = {MOVE_WING_ATTACK, MOVE_QUICK_ATTACK, MOVE_WHIRLWIND, MOVE_ENDEAVOR}
    },
    {
    .iv = 150,
    .lvl = 18,
    .species = SPECIES_GASTLY,
    .moves = {MOVE_CONFUSE_RAY, MOVE_NIGHT_SHADE, MOVE_HYPNOSIS, MOVE_SPITE}
    },
    {
    .iv = 150,
    .lvl = 18,
    .species = SPECIES_ARON,
    .moves = {MOVE_IRON_HEAD, MOVE_ROAR, MOVE_PROTECT, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 20,
    .species = SPECIES_DARTRIX,
    .moves = {MOVE_RAZOR_LEAF, MOVE_PLUCK, MOVE_ASTONISH, MOVE_GROWL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Rose5[] = {
    ...
    .lvl = 18,
    .species = SPECIES_GASTLY,
    .moves = {MOVE_CONFUSE_RAY, MOVE_SPITE, MOVE_NIGHT_SHADE, MOVE_HYPNOSIS}
    },
    {
    .iv = 150,
    .lvl = 18,
    ...
    .moves = {MOVE_MACH_PUNCH, MOVE_EMBER, MOVE_FLAME_WHEEL, MOVE_TAUNT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .lvl = 18,
    .species = SPECIES_GASTLY,
    .moves = {MOVE_HYPNOSIS, MOVE_NIGHT_SHADE, MOVE_SPITE, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 150,
    .lvl = 18,
    .species = SPECIES_ARON,
    .moves = {MOVE_IRON_HEAD, MOVE_ROCK_TOMB, MOVE_ROAR, MOVE_PROTECT}
    },
    {
    .iv = 200,
    .lvl = 22,
    .species = SPECIES_FROGADIER,
    .moves = {MOVE_QUICK_ATTACK, MOVE_LICK, MOVE_WATER_PULSE, MOVE_ROUND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .lvl = 18,
    .species = SPECIES_MURKROW,
    .moves = {MOVE_PECK, MOVE_HAZE, MOVE_TAUNT, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_SANDILE,
    .moves = {MOVE_HONE_CLAWS, MOVE_DIG, MOVE_SWAGGER, MOVE_BITE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .lvl = 18,
    .species = SPECIES_CARVANHA,
    .moves = {MOVE_LOW_KICK, MOVE_PAYBACK, MOVE_PROTECT, MOVE_SAND_ATTACK}
    },
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_HOUNDOUR,
    .moves = {MOVE_EMBER, MOVE_BITE, MOVE_SMOG, MOVE_FIRE_FANG}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 28,
    .species = SPECIES_STARAVIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_WHIRLWIND, MOVE_ENDEAVOR}
    },
    {
    .iv = 150,
    .lvl = 26,
    .species = SPECIES_HAUNTER,
    .moves = {MOVE_CONFUSE_RAY, MOVE_SUCKER_PUNCH, MOVE_HYPNOSIS, MOVE_SHADOW_BALL}
    },
    {
    .iv = 150,
    .lvl = 28,
    .species = SPECIES_ARON,
    .moves = {MOVE_IRON_HEAD, MOVE_ROAR, MOVE_PROTECT, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 200,
    .lvl = 30,
    .species = SPECIES_DARTRIX,
    .moves = {MOVE_SYNTHESIS, MOVE_PLUCK, MOVE_RAZOR_LEAF, MOVE_FORESIGHT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lola1[] = {
    ...
    .lvl = 30,
    .species = SPECIES_MONFERNO,
    .moves = {MOVE_TORMENT, MOVE_FLAME_WHEEL, MOVE_EMBER, MOVE_MACH_PUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Austina[] = {
    ...
    .lvl = 30,
    .species = SPECIES_FROGADIER,
    .moves = {MOVE_ROUND, MOVE_WATER_PULSE, MOVE_LICK, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .moves = {MOVE_PURSUIT, MOVE_HAZE, MOVE_NIGHT_SLASH, MOVE_WING_ATTACK}
    },
    {
    .iv = 100,
    .lvl = 30,
    ...
    .moves = {MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_TORMENT, MOVE_SWAGGER}
    },
    {
    .iv = 150,
    .lvl = 32,
    ...
    .moves = {MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_HOWL, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .moves = {MOVE_DESTINY_BOND, MOVE_REVENGE, MOVE_NEEDLE_ARM, MOVE_GROWTH}
    },
    {
    .iv = 100,
    .lvl = 30,
    ...
    .moves = {MOVE_BULLET_PUNCH, MOVE_HAMMER_ARM, MOVE_WORK_UP, MOVE_SLASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vincent[] = {
    ...
    .lvl = 28,
    .species = SPECIES_STARAVIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_WHIRLWIND, MOVE_DOUBLE_TEAM, MOVE_ENDEAVOR}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_HAUNTER,
    .moves = {MOVE_CONFUSE_RAY, MOVE_SUCKER_PUNCH, MOVE_SHADOW_BALL, MOVE_HYPNOSIS}
    },
    {
    .iv = 150,
    .lvl = 31,
...
static const struct TrainerMonNoItemCustomMoves sParty_Leroy[] = {
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_STARAVIA,
    .moves = {MOVE_WHIRLWIND, MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_ENDEAVOR}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_HAUNTER,
    .moves = {MOVE_SHADOW_BALL, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = 150,
    .lvl = 31,
    .species = SPECIES_FROGADIER,
    .moves = {MOVE_ROUND, MOVE_QUICK_ATTACK, MOVE_WATER_PULSE, MOVE_LICK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wilton1[] = {
    ...
    .lvl = 28,
    .species = SPECIES_STARAVIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_WHIRLWIND, MOVE_ENDEAVOR, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_HAUNTER,
    .moves = {MOVE_SHADOW_BALL, MOVE_HYPNOSIS, MOVE_SUCKER_PUNCH, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 150,
    .lvl = 31,
    .species = SPECIES_DARTRIX,
    .moves = {MOVE_SYNTHESIS, MOVE_RAZOR_LEAF, MOVE_PLUCK, MOVE_FORESIGHT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ROGGENROLA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_SAND_ATTACK, MOVE_ROCK_BLAST, MOVE_HARDEN}
    },
    {
    .iv = 150,
    .lvl = 16,
    ...
    .moves = {MOVE_HEADBUTT, MOVE_PURSUIT, MOVE_SCARY_FACE, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_REVERSAL, MOVE_UPROAR, MOVE_FURY_SWIPES}
    },
    {
    .iv = 150,
    .lvl = 20,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_GROWLITHE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_EMBER, MOVE_FLAME_WHEEL, MOVE_AGILITY}
    },
    {
    .iv = 100,
    .lvl = 22,
    ...
    .moves = {MOVE_SUNNY_DAY, MOVE_CLEAR_SMOG, MOVE_SMOKESCREEN, MOVE_FIRE_SPIN}
    },
    {
    .iv = 150,
    .lvl = 24,
    ...
    .moves = {MOVE_EMBER, MOVE_QUICK_ATTACK, MOVE_WILL_O_WISP, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_HAUNTER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_CURSE, MOVE_CONFUSE_RAY, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 26,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_BABY_DOLL_EYES, MOVE_SHADOW_SNEAK, MOVE_MIMIC}
    },
    {
    .iv = 150,
    .lvl = 28,
    ...
    .moves = {MOVE_DISABLE, MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH, MOVE_CONFUSE_RAY}
    }
};
