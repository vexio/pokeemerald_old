...
static void DisplayLevelUpStatsPg1(u8 taskId)
{
    ...
    DrawLevelUpWindowPg1(arrayPtr[12], arrayPtr, &arrayPtr[6], TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GREY, TEXT_COLOR_LIGHT_GRAY);
...
static void DisplayLevelUpStatsPg2(u8 taskId)
{
    ...
    DrawLevelUpWindowPg2(arrayPtr[12], &arrayPtr[6], TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GREY, TEXT_COLOR_LIGHT_GRAY);
    CopyWindowToVram(arrayPtr[12], 2);
    ScheduleBgCopyTilemapToVram(2);
}
